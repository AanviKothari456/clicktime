...
import { useAsync } from '@utilities/hooks'; // Import AsyncStatus
...
const FrontendTS: React.FC = () => {
	...
	React.useEffect(() => {
		...
		// Check if randomPhraseStatus indicates an error and display an error notification.
		if (randomPhraseStatus === AsyncStatus.ERROR) {
			setNotification({
				type: 'error',
				message: 'Error getting a phrase. Please try again later.',
			});
		}
	}, [randomPhraseStatus]);
	...
	return (
		<div className={styles.container}>
			...
			<main className={styles.main}>
				...
				<CTText
					as="p"
					value={`You have missed ${missedGuesses}
					 guess(es), you have ${attemptsRemaining}
					  attempt(s) left.`}
				/>
				<div>
